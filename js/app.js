...
const loadModal=()=>{
  ...
  const modalWrap=document.createElement('p');
...
;
  ModalArea.appendChild(modalWrap);
}
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <p >
    <span class="text-black">User rating: </span><span class="text-warning fw-bold"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i> ${product.rating.rate}
    </p> 
    <p>
    </span> User review: <span class="text-info fw-bold">${product.rating.count}</span>
    </p>
   <div class="card-footer">
        <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-success">Add to cart</button>
        <button onclick="loadModal()" class="btn btn-danger">Details</button>
   </div>
   </div>
      `;
